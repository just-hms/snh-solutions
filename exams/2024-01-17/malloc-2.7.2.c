...
int global_max_fast = 80;
#define av_ main_arena
#define fastbins fastbinsY
#endif
...
{
	void *last_brk = sbrk(increment);
	if (increment > 0)
		mprotect(last_brk, increment, PROT_READ|PROT_WRITE|PROT_EXEC);
	return last_brk;
}
#define MORECORE my_sbrk
#endif
...
void *mremap(void *old_address, size_t old_size,
                    size_t new_size, int flags, ... /* void *new_address */) __THROW;
#else
...
#ifndef PWNDBG_COMPAT
#define MIN_CHUNK_SIZE        (sizeof(struct malloc_chunk))
#else
#define MIN_CHUNK_SIZE	      (sizeof(struct malloc_chunk) - 2 *sizeof(void*))
#endif
...
#else
#define bin_at(m, i) ((mbinptr)((char*)&((m)->bins[((i)-1)<<1]) - (SIZE_SZ<<1)))
#endif
...
#ifndef OBJECTS
Void_t* (*__malloc_hook)(size_t bytes);
#endif
